...
public class CatalogItemRepository : ICatalogItemRepository
{
    ...
    public async Task<int> AddItem(string name, string description, decimal price, int availableStock, int catalogBrandId, int catalogTypeId, string pictureFileName)
    {
    ...
    public async Task<string> UpdateItem(int id, string name, string description, decimal price, int availableStock, int catalogBrandId, int catalogTypeId, string pictureFileName)
    {
        var itemFromDb = await _dbContext.CatalogItems.Where(i => i.Id == id).FirstAsync();
